        ...
        <div className="WelcomePage">
            <div className="WelcomePage container">
                <div className="text-center pt-3">
                    <h1 style={{color: '#7C3B1F'}}>What Happens When You <br /> Become a Yoga Health Coach?</h1>
                </div>
                <div className="row align-items-center mt-5 pt-5">
                    <div className="col-md-6 col-sm-12 p-5">
                        <div >
                            <div className="d-flex align-items-center">
                                <h1 style={{ height: '60px', width: '140px', border: '1px solid #CF6E52', borderRadius: '50%', marginRight: '50px' }} className="text-center">1</h1>
                                <div>
                        ...
                        <div >
                            <div className="d-flex align-items-center">
                                <h1 style={{ height: '60px', width: '160px', border: '1px solid #CF6E52', borderRadius: '50%', marginRight: '50px' }} className="text-center">2</h1>
                                <div>

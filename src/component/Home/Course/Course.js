        ...
        <div className="col-lg-4 col-md-6 col-sm-12 ">
            <div className="course-card mt-5">
                <div>
                    ...
                    <div className="shadow" style={{ position: 'absolute', height: '80px', width: '80px', borderRadius: '50%', marginLeft: '65%', marginTop: '2%', backgroundColor:'#CF6E52' }}>
                        <p style={{ padding: '10px', fontSize: '35px', color: 'white' }}>{'$' + course.price}</p>
